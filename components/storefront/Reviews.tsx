...
const REVIEWS: Review[] = [
  {
    ...
    rating: 5,
    textEn: 'I\'ve tried dozens of whey isolates over the years. True Formula\'s Native Isolate is on a completely different level — clean taste, zero bloating, and my recovery has never been faster. The subscription discount makes it a no-brainer.',
    textFr: 'J\'ai essayé des dizaines d\'isolats de whey au fil des années. L\'Isolat Natif de True Formula est d\'un tout autre niveau — goût pur, zéro ballonnements, et ma récupération n\'a jamais été aussi rapide. La remise abonnement est un vrai plus.',
  ...
  },
  {
    ...
    rating: 5,
    textEn: 'Pharmaceutical-grade creatine that actually dissolves properly. No gritty residue, no stomach issues. My clients and I have all switched to True Formula and the strength gains are measurable.',
    textFr: 'Une créatine de qualité pharmaceutique qui se dissout réellement. Pas de résidu granuleux, pas de problèmes d\'estomac. Mes clients et moi avons tous migré vers True Formula et les gains de force sont mesurables.',
